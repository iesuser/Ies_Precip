...
from src.views import filter_blueprint, auth_blueprint, reset_password_blueprint, stations_blueprint
...
BLUEPRINTS = [filter_blueprint, auth_blueprint, reset_password_blueprint, stations_blueprint]
